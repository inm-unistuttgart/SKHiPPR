...
def save_tikz(axes: Axes, filepath: str = None, **tikzplotlib_kwargs):
    ...
    **tikzplotlib_kwargs
    ...
    try:
        ...
        raise ImportError(
            "The (patched) 'tikzplotlib' package is required for saving TikZ files. "
            "Please install it using 'pip install tikzplotlib-patched'."
        )
    ...
    defaults = {"standalone": True, "encoding": "utf-8"}
